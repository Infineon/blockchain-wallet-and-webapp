package com.nfcweblink.infineon;

import android.util.Log;

import java.io.IOException;
import com.nfcweblink.infineon.apdu.*;
...
import com.nfcweblink.infineon.apdu.response.ResponseApdu;
import com.nfcweblink.infineon.exceptions.ExceptionHandler;
import com.nfcweblink.infineon.exceptions.NfcCardException;

import static com.nfcweblink.infineon.apdu.GenerateKeyPairApdu.CURVE_INDEX_SECP256K1;
import static com.nfcweblink.infineon.apdu.response.ResponseApdu.SW_KEY_WITH_IDX_NOT_AVAILABLE;
import static com.nfcweblink.utils.ByteUtils.bytesToHex;
import static com.nfcweblink.utils.ByteUtils.fromHexString;
...
public class NfcUtils {
    ...
    private static ResponseApdu tranceive(NfcTranceiver card, BaseCommandApdu commandApdu, String commandName)
            throws IOException, NfcCardException {
        Log.d(NfcUtils.class.getName(), String.format("CMD: %s - APDU SENT: >>> %s", commandName, commandApdu.toHexString()));
        ...
        Log.d(NfcUtils.class.getName(), String.format("CMD: %s - APDU RCVD: <<< %s", commandName, responseApdu.toHexString()));
